    ...
    return (
        <section className="contactForm">
            <div className="contactForm_left">
                ...
                <div className="contactForm_left-email"><AiOutlineMail /><span>makhmudov.zamir@gmail.com</span></div>
                <div className="contactForm_left-phone"><BsTelephone /><span>+994775023959</span></div>
            ...
            <form ref={form} onSubmit={formik.handleSubmit}>
                ...
                <input
                    ...
                    name="email"
                    type="email"
                    placeholder='zamir@makhmudov.dev'
                    onChange={formik.handleChange}
